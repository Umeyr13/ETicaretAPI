...
namespace ETicaretAPI.Persistence.Services
{
    ...
    {
        readonly IHttpContextAccessor _httpContextAccessor;// httpcontex` i içinde barındıran bir instanse döndürecektir bize bu sınıf
        ...
        public Basket? GetUserActiveBasket 
        {
            get
            {
                Basket? basket = ContextUser().Result;//prop. de async kullanamadığımız için result ile bekliyoruz.
                return basket;
            }
        }
    }
