...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> PassworReset([FromBody]PaswordResetCommanRequest paswordResetCommanRequest)
        { 
            PaswordResetCommanResponse response = await _mediator.Send(paswordResetCommanRequest);
            return Ok(response); 
        }
